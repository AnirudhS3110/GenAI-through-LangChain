# Output Parsers:
- We know the LLM just gives Text Strings as Output
- There are some LLMS which can give Structured Output on command, but some **cant**
- To the LLMs which cant give Structured Output, we use **Output Parsers**
## Formal Definition:
